...
function register_popup(id, name)
{
    ...
    element = element + '<div style="clear: both"></div></div><div class="popup-messages"></div><div><textarea class="userinput" placeholder="Type here..."></textarea><button class="btn btn-primary btn-md pull-right" onclick="sendMessage(\''+id+'\')">Send</button></div></div>';
